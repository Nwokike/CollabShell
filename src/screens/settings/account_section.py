...
def build_account_section(page: ft.Page, state, services, snack=None) -> ft.Column:
        ...
        info_dialog = ft.AlertDialog(
            ...
            title=ft.Row(
                controls=[
                    ...
                    ft.Text("Authentication Details", size=tokens.FONT_LG),
                ],
                spacing=tokens.SPACE_SM,
            ),
            content=ft.Text(msg, size=tokens.FONT_SM),
