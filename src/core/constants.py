...
ERR_QUOTA = "You may not have quota for this accelerator. Try a different one or use CPU."
...
TIP_KEEP_ALIVE = "Keeps the VM running even when idle. The session auto-terminates after 24 hours."
